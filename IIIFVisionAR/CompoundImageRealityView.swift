...
struct CompoundImageRealityView: View {
    let entityObject = CompoundEntity(width: 2.261, height: 2.309, imageURLs: [Bundle.main.url(forResource: "Hollywood", withExtension: "jpg")!, Bundle.main.url(forResource: "Hollywood", withExtension: "jpg")!, Bundle.main.url(forResource: "Hollywood", withExtension: "jpg")!, Bundle.main.url(forResource: "Hollywood", withExtension: "jpg")!])

    var body: some View {
        RealityView { content in
            try! await entityObject.setInitialPage(frontImageURL: Bundle.main.url(forResource: "Hollywood", withExtension: "jpg"), backImageURL: Bundle.main.url(forResource: "Hollywood", withExtension: "jpg"))
